...
import { generateUniqueId, generateSessionTitle, pcmBase64ToWavUrl } from '../utils/appUtils';
...
export const useTtsImagenSender = ({
    ...
    const handleTtsImagenMessage = useCallback(async (
        ...
        try {
            ...
            handleApiError(error, currentSessionId, modelMessageId, isTtsModel ? "TTS Error" : "Image Gen Error", keyToUse);
        } finally {
