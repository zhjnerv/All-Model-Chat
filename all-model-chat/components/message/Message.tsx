...
export const Message: React.FC<MessageProps> = React.memo((props) => {
    ...
    const bubbleClasses = `w-fit max-w-[calc(100%-2.75rem)] sm:max-w-2xl lg:max-w-3xl xl:max-w-4xl p-2.5 sm:p-3 rounded-2xl shadow-md flex flex-col min-w-0 ${isModelThinkingOrHasThoughts ? 'min-w-[320px]' : ''}`;
