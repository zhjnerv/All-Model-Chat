    ...
    <div className="mt-5 flex-shrink-0 flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-[var(--theme-border-primary)]">
      ...
      <div className="flex items-center gap-2 w-full sm:w-auto">
        <button
          onClick={onReset}
          type="button"
          className={`${baseButtonClass} w-1/2 sm:w-auto border border-transparent text-[var(--theme-text-tertiary)] hover:bg-[var(--theme-bg-tertiary)] hover:text-[var(--theme-text-secondary)] focus:ring-[var(--theme-border-secondary)]`}
        ...
        <button
          ...
          type="button"
          className={`${baseButtonClass} w-1/2 sm:w-auto border border-transparent text-[var(--theme-text-danger)] hover:bg-[var(--theme-bg-danger)] hover:bg-opacity-10 focus:ring-[var(--theme-bg-danger)]`}
      ...
      <div className="flex items-center gap-2 w-full sm:w-auto">
        <button
          onClick={onCancel}
          type="button"
          className={`${baseButtonClass} w-1/2 sm:w-auto bg-[var(--theme-bg-secondary)] hover:bg-[var(--theme-bg-tertiary)] text-[var(--theme-text-secondary)] hover:text-[var(--theme-text-primary)] border border-[var(--theme-border-secondary)] focus:ring-[var(--theme-border-secondary)]`}
        >
        ...
        <button
          onClick={onSave}
          type="button"
          className={`${baseButtonClass} w-1/2 sm:w-auto bg-[var(--theme-bg-accent)] hover:bg-[var(--theme-bg-accent-hover)] text-[var(--theme-text-accent)] focus:ring-[var(--theme-border-focus)] shadow-sm hover:shadow-md`}
        >
