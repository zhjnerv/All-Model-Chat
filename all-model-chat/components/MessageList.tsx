...
const HtmlPreviewModal = lazy(() => import('./HtmlPreviewModal').then(module => ({ default: module.HtmlPreviewModal })));
const ImageZoomModal = lazy(() => import('./ImageZoomModal').then(module => ({ default: module.ImageZoomModal })));
