export const messagesTranslations = {
    ...
    suggestion_summarize_title: { en: 'Summarize text', zh: '总结文字' },
    suggestion_summarize_desc: { en: 'Summarize the following text', zh: '总结以下文字' },
    ...
    suggestion_prompt_label: { en: 'Send', zh: '发送' },
