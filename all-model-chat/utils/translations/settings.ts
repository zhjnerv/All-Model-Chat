export const settingsTranslations = {
    ...
    settingsTabGeneral: { en: 'General', zh: '通用' },
    settingsTabUI: { en: 'Interface', zh: '界面' },
    settingsTabAppearance: { en: 'Appearance', zh: '外观' },
    settingsTabModel: { en: 'Model', zh: '模型' },
    settingsTabConversation: { en: 'Conversation', zh: '对话' },
    ...
    settingsChatBehavior: { en: 'Model Parameters (for New Chats)', zh: '模型参数 (用于新对话)' },
    ...
    settingsReset: { en: 'Reset to Defaults', zh: '重置为默认值' },
    ...
    settingsClearHistory: { en: 'Clear History', zh: '清空历史对话' },
    ...
    settingsClearCache: { en: 'Clear All Data', zh: '清除所有数据' },
