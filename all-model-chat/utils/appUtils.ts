...
export const translations = {
    ...
    settingsUseProxy: { en: 'Use Proxy URL', zh: '使用代理 URL' },
    settingsProxyUrl: { en: 'Proxy URL', zh: '代理 URL' },
    settingsProxyUrlHelpText: { en: 'Proxy URL supported by https://api-proxy.me/', zh: '代理 URL 由 https://api-proxy.me/ 提供支持' },
