...
export const translations = {
    ...
    appDragDropHelpText: { en: 'Images, Videos, Audio, PDFs & Text files', zh: '支持图片、视频、音频、PDF和文本文件' },
    ...
    settingsApiUrl: { en: 'Custom API Endpoint', zh: '自定义 API 端点' },
    settingsApiUrlHelpText: { en: 'e.g., your-proxy.com (hostname only). Leave blank for default.', zh: '例如：your-proxy.com (仅主机名)。留空则使用默认值。' },
    ...
    apiConfig_apiUrl_placeholder: { en: 'Enter Custom API Endpoint Hostname', zh: '输入自定义 API 端点主机名' },
