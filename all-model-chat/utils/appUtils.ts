...
export const translations = {
    ...
    settingsApiUrlHelpText: { en: 'Your custom proxy or compatible API endpoint. Changes require a page reload.', zh: '您的自定义代理或兼容的 API 端点。更改需要刷新页面。' },
    ...
    apiConfig_url_placeholder: { en: 'e.g., https://my-proxy.com/v1beta', zh: '例如 https://my-proxy.com/v1beta' },
